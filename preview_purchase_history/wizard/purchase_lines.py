...
class PrevPurchaseLineWiz(models.TransientModel):
    _name = "purchase.line.prev"
    _order = 'date desc'
    
    wiz_id = fields.Many2one('purchase.line.wizard')
...
class PurchaseOrderLineWiz(models.TransientModel):
    ...
    purchase_lines = fields.One2many('purchase.line.prev', 'wiz_id', string="Purchases", default=_get_purchase_lines)
